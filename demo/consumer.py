...
def post_process(all_middle_json,processed_pdf_file_names,results,processed_pdf_bytes_list,local_md_dirs,local_image_dirs,md_writers,
        f_draw_layout_bbox,
        f_draw_span_bbox,
        f_dump_orig_pdf,
        f_dump_md,
        f_dump_content_list,f_dump_middle_json, 
        f_dump_model_output,
        f_make_md_mode):
